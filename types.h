...
# define RV54B    (545)	/* Rogue 5.4.5 - Rogue 5.4.4 with lots of bug fixes */

# define supported_rogue() (version >= RV54B)
# define modern_rogue() (version >= RV52A)
...
/* deep level - historically level 18 was considered deep for some rogomatic reason */
# define LVL_DEEP (18)
