...
SH_SRC= run_rogo.sh rerun_rogo.sh unstuck_player.sh end_player.sh mrerun_rogo.sh
...
# NOTE: The modern_curses.h file doesn't need these make variables, we simply test them here as a convenience.
#
...
ltm.o: config.h
ltm.o: globals.h
ltm.o: have_strlcat.h
ltm.o: have_strlcpy.h
ltm.o: install.h
ltm.o: ltm.c
...
search.o: config.h
search.o: globals.h
search.o: modern_curses.h
search.o: search.c
search.o: types.h
setup.o: config.h
setup.o: have_strlcat.h
