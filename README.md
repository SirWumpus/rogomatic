...
To view the top rogue scores generated by `./rerun_rogo`:
...
... while `./rerun_rogo` is rolling, then it will **NOT** start a new
...
The `rogue(6)` game used by `./rerun_rogo` and friends is searched for as follows:
